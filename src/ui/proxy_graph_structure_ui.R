                   ...
                   tabPanel(
                     ...
                     fluidRow(
                       tabBox( id = 'tab_filtros',
                         ...
                         tabPanel(
                           ...
                           column(
                             ...
                             selectizeInput("op_parentes", 
                                            ...
                                            width = '100%'))),
                         tabPanel(
                           'Vínculos empegatícios', value = 'tab_servidor',
                           column(
                             width = 6,
                         ...
                         tabPanel(
                           'Vínculos societários', value = 'tab_socio',
                           column(
                             width = 6,
                         ...
                         tabPanel(
                           ...
                           column(
                             ...
                             dateRangeInput("sldFiltroTemporalEmpenhos", label = "Filtro temporal empenhos",
                                            ...
                                            separator = 'à',
                                            startview = 'year'),
                             actionButton("sincronizar_emp", label = "Sincronizar Todos"),
                             tags$head(tags$style(type="text/css", "#sincronizar_emp {background-color:#428bca;color: #fff}"))
                             )
                         ),
                         tabPanel(
                           'Sanções'))))
